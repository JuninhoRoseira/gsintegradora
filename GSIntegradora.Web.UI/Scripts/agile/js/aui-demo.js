...
$(function() {
  ...
  $('.add-fixed-header').click(function(){

    $('body').removeClass('fixed-header');
    headerCookie = $.cookie('header', 'fixed');
    $(this).addClass('hidden');
    $('.rm-fixed-header').removeClass('hidden');

  });

  $('.rm-fixed-header').click(function(){

    $('body').addClass('fixed-header');
    headerCookie = $.cookie('header', 'rm-fixed');
    $(this).addClass('hidden');
    $('.add-fixed-header').removeClass('hidden');

  });

  var headerCookie = $.cookie('header');

  if (headerCookie == 'fixed') {
    $('.add-fixed-header').addClass('hidden');
    $('.rm-fixed-header').removeClass('hidden');
    $('body').removeClass('fixed-header');
  }
...
$(function() {
  ...
  $('.add-fixed-sidebar').click(function(){

    layoutFormatter();

    $('body').removeClass('fixed-sidebar');
    sidebarCookie = $.cookie('sidebar', 'fixed');
    $(this).addClass('hidden');
    $('.rm-fixed-sidebar').removeClass('hidden');

  });

  $('.rm-fixed-sidebar').click(function(){

    layoutFormatter();

    $('body').addClass('fixed-sidebar');
    sidebarCookie = $.cookie('sidebar', 'rm-fixed');
    $(this).addClass('hidden');
    $('.add-fixed-sidebar').removeClass('hidden');

  });

  var sidebarCookie = $.cookie('sidebar');

  if (sidebarCookie == 'fixed') {
    $('.add-fixed-sidebar').addClass('hidden');
    $('.rm-fixed-sidebar').removeClass('hidden');
    $('body').removeClass('fixed-sidebar');
  }
...
$(function() {
  ...
  $('.add-fixed-footer').click(function(){

    $('body').addClass('fixed-footer');
    footerCookie = $.cookie('footer', 'fixed');
    $(this).addClass('hidden');
    $('.rm-fixed-footer').removeClass('hidden');

  });

  $('.rm-fixed-footer').click(function(){

    $('body').removeClass('fixed-footer');
    footerCookie = $.cookie('footer', 'rm-fixed');
    $(this).addClass('hidden');
    $('.add-fixed-footer').removeClass('hidden');

  });

  var footerCookie = $.cookie('footer');

  if (footerCookie == 'fixed') {
    $('.add-fixed-footer').addClass('hidden');
    $('.rm-fixed-footer').removeClass('hidden');
    $('body').addClass('fixed-footer');
  }
...
//$(document).on( 'click', function(){
	//$('.change-layout-theme a').click(function(){
	    ...
	    var layoutTheme = "gray";
	    var elementsTheme = "orange";

		//var layoutTheme = $(this).attr('layout-theme');
		//var elementsTheme = $(this).attr('elements-theme');

		if ( layoutTheme != '' ) {

			$("#layout-theme").attr("href","/Content/agile/themes/minified/agileui/color-schemes/layouts/" + layoutTheme + ".min.css");

			$("#elements-theme").attr("href","/Content/agile/themes/minified/agileui/color-schemes/elements/" + elementsTheme + ".min.css");

			var setLayoutThemeCookie = $.cookie('set-layout-theme', layoutTheme);

			var setElementsThemeCookie = $.cookie('set-elements-theme', elementsTheme);
...
function themefromCookie(){
	...
	var elementsThemefromCookie = $.cookie('set-elements-theme');

	if ( layoutThemefromCookie != null ) {

		$("#layout-theme").attr("href","/Content/agile/themes/minified/agileui/color-schemes/layouts/" + layoutThemefromCookie + ".min.css");

	}

	if ( elementsThemefromCookie != null ) {

		$("#elements-theme").attr("href","/Content/agile/themes/minified/agileui/color-schemes/elements/" + elementsThemefromCookie + ".min.css");
  ...
  $(function(){
	  ...
	  $('.demo-triggers a').hover(function(){

	    var applyClass = $(this).attr('data-color-style');
	    $('.color-style-demo .ui-state-default').removeClass('ui-state-default').addClass(applyClass);
	  },
	  function(){
	    var applyClass = $(this).attr('data-color-style');
	    $('.color-style-demo .' + applyClass).addClass('ui-state-default').removeClass(applyClass);
	  });
...
$(function() {
  ...
  /* Custom Inputs */
    ...
    $(function () {
      ...
      $('.checker span').append('<i class="glyph-icon icon-check"></i>').addClass('ui-state-default btn radius-all-4');
